...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const validInterviewTypes = ["Technical", "Behavioral", "Easy", "Complex", "Medium"];
    ...
    const apiUrl = `https://hr-recruitment-ai-api.onrender.com/generate-interview-agenda?interview_type=${encodeURIComponent(interview_type)}`;
